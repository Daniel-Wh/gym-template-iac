...
export class BackendNpInfraStack extends TerraformStack {
    ...
    constructor(scope: Construct, name: string) {
        ...
        const userStore = new AddDynamoStore(this, 'Users', {
            name: 'Users-nonprod',
        ...
        const userStats = new AddDynamoStore(this, "User-Stats", {
        ...
        envs.forEach(env => {
            ...
            const apiGw = new AddApiGateway(this, `backend-services-${env}`, {
